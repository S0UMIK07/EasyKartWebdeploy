 ...
 <%
       ...
       %>
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item me-3"> <div class="cart-co"> <i class="fa badge fa-lg" onmouseover="this.style.color='#EDEADE'" onmouseout="this.style.color='white'" data-bs-toggle="modal" data-bs-target="#add-to-cart" >&#xf07a; <span class="cart-items">(0)</span></i></div> </li>
