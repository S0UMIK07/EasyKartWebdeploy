...
import com.mycompany.mycart.dao.EditUserDao;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           if(div.trim().equals("na")){
               ...
               EditUserDao editUserDao=new EditUserDao(FactoryProvider.getFactory());
               int t=editUserDao.EditUserName(uid, PhoneNo);
               HttpSession httpSession=request.getSession();
               if(t!=0)
               {
               ...
               EditUserDao editUserDao=new EditUserDao(FactoryProvider.getFactory());
               int t=editUserDao.EditUserName(uid, Pass);
               HttpSession httpSession=request.getSession();
               if(t!=0)
               {
               ...
               EditUserDao editUserDao=new EditUserDao(FactoryProvider.getFactory());
               int t=editUserDao.EditUserName(uid, Add);
               HttpSession httpSession=request.getSession();
               if(t!=0)
               {
