...
<%@page import="com.mycompany.mycart.entities.OrderItem"%>
<%@page import="com.mycompany.mycart.entities.Order"%>
<%@page import="com.mycompany.mycart.entities.Product"%>
<%@page import="java.util.List"%>
<%@page import="com.mycompany.mycart.dao.OrderDao"%>
<%@page import="com.mycompany.mycart.helper.FactoryProvider"%>
<%@page import="com.mycompany.mycart.entities.User"%>
<%@page import="com.mycompany.mycart.entities.DeliveryAddress"%>
<%
